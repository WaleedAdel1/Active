...
let ContactUsComponent = class ContactUsComponent {
    ...
    OnSubmit(form) {
        const allInfo = `My name is ${this.Name}.  My number is ${this.Phone}. My email is ${this.Email}. My message is ${this.Message}`;
        alert(allInfo);
...
let ImageBackgroundComponent = class ImageBackgroundComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let ServicePageComponent = class ServicePageComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let SomeGalleryHomeComponent = class SomeGalleryHomeComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let SideIconComponent = class SideIconComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let StickySocialBarComponent = class StickySocialBarComponent {
    constructor() { }
    ngOnInit() {
    }
};
